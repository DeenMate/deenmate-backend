import { Controller, Get, Post, Body, Query, ParseFloatPipe, ValidationPipe } from '@nestjs/common';
import { ZakatService, NisabValues, ZakatCalculation, GoldPrice } from './zakat.service';
...
export class ZakatController {
  ...
  @Get('nisab')
  @ApiOperation({ summary: 'Get Nisab values', description: 'Returns Nisab thresholds based on gold/silver prices' })
