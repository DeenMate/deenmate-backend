...
export class PrayerController {
  ...
  @Get("methods")
  @ApiOperation({
    summary: "List prayer calculation methods",
    description: "Upstream-compatible with aladhan.com/v1/methods",
  })
  @ApiResponse({ status: 200, description: "Success" })
  async getCalculationMethods(@Res() res: Response) {
    const result =
      (await this.prayerService.getCalculationMethods()) as ServiceResponse;
  ...
  @ApiOperation({
    summary: "Get specific calculation method",
    description: "Upstream-compatible with aladhan.com/v1/methods/{id}",
  })
  @ApiResponse({ status: 200, description: "Success" })
  ...
  async getCalculationMethod(
    ...
    const result = (await this.prayerService.getCalculationMethod(
      methodCode,
    )) as ServiceResponse;
  ...
  @ApiResponse({ status: 200, description: "Success" })
  @ApiResponse({ status: 404, description: "Not Found" })
  async getLocation(@Res() res: Response, @Param("locKey") locKey: string) {
    const result = (await this.prayerService.getLocation(
      locKey,
    )) as ServiceResponse;
  ...
  @Get("timings")
  @ApiOperation({
    summary: "Get daily prayer times by coordinates",
    description: "Upstream-compatible with aladhan.com/v1/timings",
  })
  @ApiQuery({
    name: "latitude",
    required: true,
  ...
  @ApiQuery({
    ...
    description: "0=None,1=Middle,2=OneSeventh",
    example: 1,
  })
  @ApiQuery({
    name: "tune",
    required: false,
    description: "Comma-separated 7 integer minute offsets (Fajr,...,Isha)",
  ...
  @Get("timingsByCity")
  @ApiOperation({
    summary: "Get daily prayer times by city",
    description: "Upstream-compatible with aladhan.com/v1/timingsByCity",
  })
  @ApiQuery({
    name: "city",
    required: true,
  ...
  @Get("calendar")
  @ApiOperation({
    summary: "Get monthly prayer calendar by coordinates",
    description: "Upstream-compatible with aladhan.com/v1/calendar",
  })
  @ApiQuery({
    name: "latitude",
    required: true,
  ...
  @ApiOperation({
    ...
    description:
      "Upstream-compatible with aladhan.com/v1/calendar/{year}/{month}. Example: /prayer/times/loc_23.8103_90.4125/monthly/2025/9?method=2&school=1&lat=23.8103&lng=90.4125&latitudeAdjustmentMethod=1&tune=1,2,3,4,5,6,7&timezonestring=Asia/Dhaka",
  })
  @ApiQuery({
    name: "method",
    required: false,
