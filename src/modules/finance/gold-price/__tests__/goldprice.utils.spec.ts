import { detectChangeDirection, normalizeBanglaNumberToFloat } from '../goldprice.utils';
...
describe('goldprice.utils', () => {
  it('detectChangeDirection works', () => {
    ...
    expect(detectChangeDirection(100, 100)).toBe(PriceChangeDirection.Unchanged);
  });
